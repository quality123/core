...
interface ISystemTagObjectMapper {
	 ...
	 * @param string $objectType object type
	 * @param string $tagIds tag id or array of tag ids to check
	 * @param bool $all true to make sure that ALL objects have ALL the tags,
	 * false if at least ONE object has ALL the tags.
	 *
	 ...
	 * @since 9.0.0
	 */
	public function hasTags($objIds, $objectType, $tagIds, $all = true);
